...
/***/ function(module, exports, __webpack_require__) {
	...
	var Smpl = function (_React$Component) {
	  _inherits(Smpl, _React$Component);

	  function Smpl() {
	    _classCallCheck(this, Smpl);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Smpl).apply(this, arguments));
	  }
	...
	(0, _reactDom.render)(_react2.default.createElement(Smpl, null), document.getElementById('content'));
